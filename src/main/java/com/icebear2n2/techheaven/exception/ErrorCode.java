...
public enum ErrorCode {
    ...
    USER_WISH_NOT_FOUND(HttpStatus.NOT_FOUND, "USER WISH NOT FOUND."),
    ...
    PRODUCT_ID_NULL(HttpStatus.NOT_FOUND, "PRODUCT ID NULL."),
    USER_ID_NULL(HttpStatus.NOT_FOUND, "USER ID NULL."),
    USER_WISH_ID_NULL(HttpStatus.NOT_FOUND, "USER WISH ID NULL."),
    ;
